...
-- Seed completo do appointment-service
--
-- NOTAS DE MAPEAMENTO:
-- * doctor_id e patient_id referenciam o profile_id (profile-service).
-- * Consultas 1 a 6: Concluídas (possuem prontuário, prescrição e exames).
...
VALUES
    (1, 1, 'Prescrição de rotina. Retorno em 30 dias com resultados dos exames.', '2026-02-12 10:28:00', 'DISPENSED'),
    (2, 2, 'Tratamento para hipertensão arterial estágio 1. Monitorar PA semanalmente.', '2026-02-15 14:28:00', 'DISPENSED'),
    (3, 3, 'Tratamento de infecção viral com antibioticoterapia empírica e antitérmico.', '2026-02-20 09:28:00', 'DISPENSED'),
    (4, 4, 'Anti-inflamatório para gonartrose. Evitar impacto. Iniciar fisioterapia.', '2026-02-25 11:43:00', 'ISSUED'),
    (5, 5, 'Antifúngico para dermatite de contato por sensibilização ao níquel. Evitar bijuteria.', '2026-03-01 15:28:00', 'ISSUED'),
    (6, 6, 'Profilaxia de enxaqueca com beta-bloqueador + analgésico para crises agudas.', '2026-03-05 10:28:00', 'ISSUED');
...
VALUES
    (1, 'Check-up anual de rotina', 'Paciente de 34 anos, sexo masculino, sem queixas agudas.', 'PA: 120/80 mmHg. FC: 72 bpm. Exame físico geral sem alterações.', 'Assintomático', 'Z00.0', 'Exame médico geral', 'Solicitação de exames de rotina.', 'Hemograma completo, Glicemia em jejum, TSH', 'Orientado sobre alimentação saudável.', '2026-02-12 10:28:00', '2026-02-12 10:28:00'),
    (2, 'Dor precordial e dispneia aos esforços', 'Paciente de 37 anos, queixa de dor no peito e cansaço.', 'PA: 148/95 mmHg. Ritmo cardíaco regular.', 'Precordialgia, dispneia', 'I10', 'Hipertensão arterial primária', 'Iniciado Losartana + Atorvastatina. Orientado dieta.', 'Ecocardiograma transtorácico, Perfil lipídico, ECG', 'Monitorar PA em casa.', '2026-02-15 14:28:00', '2026-02-15 14:28:00'),
    (3, 'Febre e tosse em criança (7 anos)', 'Febre (38,5°C) há 2 dias, tosse seca e inapetência.', 'Temperatura: 38,2°C. Orofaringe hiperemiada.', 'Febre, tosse seca, inapetência', 'J06.9', 'Infecção aguda de vias aéreas', 'Amoxicilina + Paracetamol.', NULL, 'Sinais de alarme explicados à mãe.', '2026-02-20 09:28:00', '2026-02-20 09:28:00'),
    (4, 'Dor e limitação funcional no joelho direito', 'Dor progressiva no joelho direito há 3 semanas.', 'Marcha antálgica. Joelho com crepitação.', 'Dor articular, rigidez matinal', 'M17.1', 'Gonartrose primária', 'Ibuprofeno. Fisioterapia.', NULL, 'Discutida possibilidade de artroplastia futura.', '2026-02-25 11:43:00', '2026-02-25 11:43:00'),
    (5, 'Lesão eritematosa e pruriginosa no antebraço', 'Erupção avermelhada após uso de pulseira.', 'Placas eritematosas com vesiculação leve.', 'Prurido, eritema', 'L23.0', 'Dermatite de contato', 'Fluconazol + Desonida creme.', NULL, 'Retorno em 30 dias.', '2026-03-01 15:28:00', '2026-03-01 15:28:00'),
    (6, 'Cefaleia intensa recorrente há 6 meses', 'Cefaleia pulsátil unilateral, com náuseas e fotofobia.', 'Exame neurológico normal.', 'Cefaleia pulsátil, náusea', 'G43.1', 'Enxaqueca com aura', 'Metoprolol Succinato + Naratriptana.', 'Ressonância Magnética do Encéfalo', 'Manter diário de cefaleias.', '2026-03-05 10:28:00', '2026-03-05 10:28:00');
...
VALUES
    (1, 'LAB-2026-001', 1, 1, '2026-02-12 10:25:00', 'Exames de rotina.', 'COMPLETED'),
    (2, 'LAB-2026-002', 2, 2, '2026-02-15 14:25:00', 'Avaliação cardiovascular.', 'COMPLETED'),
    (3, 'LAB-2026-003', 6, 6, '2026-03-05 10:25:00', 'RNM para exclusão de causas secundárias.', 'PENDING');
...
VALUES
    (1, '120/80', 95.0, 70.0, 1.72, 23.7, 72, '2026-02-12 10:05:00'), -- Patient Demo
    (2, '148/95', 110.0, 85.0, 1.75, 27.8, 82, '2026-02-15 14:05:00'), -- João (Consulta)
    (3, '100/65', 88.0, 25.0, 1.22, 16.8, 98, '2026-02-20 09:05:00'), -- Maria
    (4, '128/84', 102.0, 94.0, 1.80, 29.0, 76, '2026-02-25 11:05:00'), -- Pedro
    (5, '115/74', 90.0, 57.0, 1.63, 21.4, 68, '2026-03-01 15:05:00'), -- Ana
    (6, '132/86', 104.0, 79.0, 1.78, 24.9, 80, '2026-03-05 10:05:00'), -- Lucas
    (2, '135/88', 108.0, 85.0, 1.75, 27.8, 78, '2026-03-01 09:00:00'); -- João (Retorno PA)